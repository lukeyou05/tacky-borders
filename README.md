...
If you don't want to build the feature use their [Pre-Built Release](https://github.com/lukeyou05/tacky-borders/releases) then just download this repo for the color-presets folder  
